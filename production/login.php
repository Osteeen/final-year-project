      ...
      <div class="animate form login_form">
        <section class="login_content">
          <form method="POST">
            <h1>Admin Login</h1>
            <div>
              <input type="text" class="form-control" placeholder="Username" required="" name="staff_ID" />
            </div>
            <div>
      ...
      <div id="register" class="animate form registration_form">
        <section class="login_content">
          <form method="POST">
            <h1>Admin SignUp</h1>
            <div>
              <input type="text" class="form-control" placeholder="staff_ID" required="" name="staff_ID" />
            </div>
            <div>
              <input type="email" class="form-control" placeholder="Email" required="" name="email" />
            </div>
            <div>
              <input type="password" class="form-control" placeholder="pass" required="" name="pass" />
            </div>
            <div>
              <input type="password" class="form-control" placeholder="pass2" required="" name="pass2" />
            </div>
            <div>
