                  ...
                  <div class="x_content">
                    ...
                    >
                      ...
                      <div class="form-group row">
                        <label
                          class="control-label col-md-3 col-sm-3 label-align"
                      ...
                      <div class="file-field item form-group row">
                        ...
                        >
                        <div
                          class="btn btn-primary btn-sm col-md-6 col-sm-6"
                          type="button"
                          required="required"
                          class="btn btn-primary form-group row btn-sm col-md-6 col-sm-6"
                          data-toggle="modal"
